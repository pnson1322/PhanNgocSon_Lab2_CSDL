...
WHERE NOT LoaiKyNang = N'Ngôn ngữ lập trình'
...
SELECT COUNT(MaChuyenGia) FROM ChuyenGia
...
SELECT COUNT(MaDuAn) AS DEM FROM DuAn
WHERE TrangThai = N'Đang thực hiện'
GROUP BY MaCongTy
...
SELECT TenKyNang, COUNT(MaChuyenGia) FROM KyNang, ChuyenGia_KyNang
